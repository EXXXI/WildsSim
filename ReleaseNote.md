...
2026/2/28 フルドレスとププロフェイクを解放

2026/2/19 コンテスト大剣を追加、今後の装備を未開放状態でデータ追加

2026/2/18 シュバルカγ、クイーンα、鎖刃・痛撃の護石Ⅲを追加

2026/1/31 護石設定画面にて、登録されている護石に対して、上位互換や同値の護石が登録されていた場合にメッセージを表示

2026/1/30 にゃんにゃんぼう解放

2026/1/14 はりきりモリバー解放

2026/1/12 アーティア武器に付かないスキルをアーティアの選択対象・検索対象から除外

2025/12/30 一部のレア6防具(初期防御力44の防具)がレア7になっていたので修正

2025/12/26 転福の護石Ⅲが抜けていたので追加、今後の装備を未開放状態でデータ追加

2025/12/24 ダハディラγと挑戦の護石Ⅲを追加

2025/12/23 護石・アーティア・マイセットのドラッグでの移動でエラーが起こる場合があったので修正

2025/12/19 祭り関連の装備を追加

2025/12/18 スキルを1種のみでアーティア武器を登録すると意図しない挙動になっていたので修正

2025/12/16 限界突破強化のスロット変化の仕様を実機に合わせて固定、ゴグ装備と追加護石2種と新スキル1つを追加、特定条件で検索時にエラー落ちする不具合を修正

2025/12/12 12/11のショーケースの内容に合わせて限界突破強化のスロット変化の仕様を変更、護石登録時のスロット操作UIにクリアボタンを追加、シルドコートが足装備になっていたので修正

2025/12/6 TU4に向けてアーティア関連と限界突破強化関連の機能を追加

2025/12/1 肉双剣を解放

2025/11/15 レア度に応じて最大防御力を算出する機能を追加、防具のレア度のデータが入っていなかった個所を補完
