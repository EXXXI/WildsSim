...
- 限界突破強化関連
  ...
  - レア5,6のスロット強化は、以下の4種を用意しています。conf/LogicConfig.csvの「(仮)限界突破スロットの挙動」に対応する番号をいれることで選択できます(初期設定2)。
    - 0:全スロットを+1(3が上限)
    - 1:怪異錬成の方式でレア5は+3、レア6は+1
    - 2:怪異錬成の方式でレア5は+3、レア6は+2
    - 3:怪異錬成の方式でレア5もレア6も+3
...
本体の最終更新：2025/12/6 TU4に向けてアーティア関連と限界突破強化関連の機能を追加
