...
本体の最終更新：2026/9/4 内部挙動を更新、いくつかのバグ修正
 - 護石検索時に複数の結果が同一護石として1件に統合されてしまう場合があったので修正
 - アーティア武器をマイ検索条件にした場合に表示が変になっていたので修正
 - アーティア武器のCSVにてマイセット登録中の印が正常に表示されていなかったので修正

CSVの最終更新：2026/3/4 蒼世関係の装備を解放
