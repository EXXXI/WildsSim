...
## 注意(8/12更新のバージョン20250812.0について)

護石関連の機能を追加していますが、開発時点でアプデ配信前のため、仕様には予想が含まれています。

以下二点ご了承の上ご利用ください。
- 実際のゲームの仕様によっては対応しきれない可能性があること
  - (できるだけ多くの状況に対応できるように作ったつもりではありますが・・・)
- アプデ後に大きく変更が加えられる可能性があること

## 更新・対応状況

本体の最終更新：2025/8/12 護石関連の機能を追加
